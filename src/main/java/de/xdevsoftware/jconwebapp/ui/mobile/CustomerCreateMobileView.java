...
@Route(value = "customer-create-mobile", layout = MainLayout.class)
public class CustomerCreateMobileView extends VerticalLayout implements HasTitle
{
	private Customer customer = new Customer();

	public CustomerCreateMobileView()
	{
		super();
		this.initUI();
	}
